...
# Dataset Name: Florida Professional Licenses
# Task #:       10
# Created:      February 2021
# Migrated:     May 2021

# ruby mlc.rb --tool="clean::fl::fl_professional_licenses"
# ruby mlc.rb --tool="clean::fl::fl_professional_licenses" --mode='holders'
# ruby mlc.rb --tool="clean::fl::fl_professional_licenses" --mode='cities'
# ruby mlc.rb --tool="clean::fl::fl_professional_licenses" --mode='counties'
...
def execute(options = {})
  ...
  when :counties
    clean_counties(CL_CITY_TBL_INFO, where_part, route_db01)
  else
