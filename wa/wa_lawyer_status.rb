...
# Dataset Name: WA Lawyer Status
# Task #:       76
# Scrape Task:  https://lokic.locallabs.com/scrape_tasks/152
# Created:      June 2022

# ruby mlc.rb --tool="clean::wa::wa_lawyer_status"
# ruby mlc.rb --tool="clean::wa::wa_lawyer_status" --mode='city'
# ruby mlc.rb --tool="clean::wa::wa_lawyer_status" --mode='zip'

def execute(options = {})
  route = C::Mysql.on(DB01, 'lawyer_status')
  table_description = {
    city: {
      raw_table: 'washington',
      clean_table: 'washington__cities_clean',
...
def message_to_slack(message)
  Slack::Web::Client.new.chat_postMessage(
    channel: 'UKLB1JGDN',
    text: "*[CLEANING #76] WA Lawyer Status* \n>#{message}",
    as_user: true
  )
end
