...
# Dataset Name: New York State Employee Salary
# Task #:       25
# Created:      May 2021

# ruby mlc.rb --tool="clean::ny::ny_state_employee_salary"
# ruby mlc.rb --tool="clean::ny::ny_state_employee_salary" --where="total_compensation LIKE '$%'"
# ruby mlc.rb --tool="clean::ny::ny_state_employee_salary" --mode='name'
# ruby mlc.rb --tool="clean::ny::ny_state_employee_salary" --mode='employer'
# ruby mlc.rb --tool="clean::ny::ny_state_employee_salary" --mode='agency' --where="total_compensation LIKE '$%'"
# ruby mlc.rb --tool="clean::ny::ny_state_employee_salary" --mode='job_title'
...
def execute(options = {})
  ...
  table_description = {
      name: {
          ...
          clean_table: 'ny_state_employee_salary__names_clean',
